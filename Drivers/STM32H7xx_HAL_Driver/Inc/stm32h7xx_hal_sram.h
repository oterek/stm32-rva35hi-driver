...
typedef enum
{
  ...
  HAL_SRAM_STATE_BUSY      = 0x02U,  /*!< SRAM peripheral busy                            */
  HAL_SRAM_STATE_ERROR     = 0x03U,  /*!< SRAM peripheral error                           */
  HAL_SRAM_STATE_PROTECTED = 0x04U   /*!< SRAM peripheral protected                       */
...
#endif /* USE_HAL_SRAM_REGISTER_CALLBACKS  */
{
  ...
  FMC_NORSRAM_ExtendedTypeDef   *Extended;  /*!< Extended mode register base address          */
