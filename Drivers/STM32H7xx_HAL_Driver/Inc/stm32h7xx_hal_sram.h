...
typedef enum
{
  HAL_SRAM_STATE_RESET     = 0x00U,  /*!< SRAM peripheral not yet initialized or disabled */
  HAL_SRAM_STATE_READY     = 0x01U,  /*!< SRAM peripheral ready                           */
  HAL_SRAM_STATE_BUSY      = 0x02U,  /*!< SRAM peripheral internal process is ongoing     */
  HAL_SRAM_STATE_ERROR     = 0x03U,  /*!< SRAM peripheral error state                     */
...
#endif /* USE_HAL_SRAM_REGISTER_CALLBACKS */
{
  ...
  void  *MspInitCallback;                   /*!< SRAM Msp Init callback                       */
  void  *MspDeInitCallback;                 /*!< SRAM Msp DeInit callback                     */
  void  *DmaXferCpltCallback;               /*!< SRAM DMA Xfer Complete callback              */
  void  *DmaXferErrorCallback;              /*!< SRAM DMA Xfer Error callback                 */
...
typedef enum
{
  ...
  HAL_SRAM_DMA_XFER_ERR_CB_ID   = 0x03U   /*!< SRAM DMA Xfer Error Callback ID    */
...
/** @brief Reset SRAM handle state
  * @param  __HANDLE__ specifies the SRAM handle.
  * @retval None
  */
#if (USE_HAL_SRAM_REGISTER_CALLBACKS == 1)
...
#if (USE_HAL_SRAM_REGISTER_CALLBACKS == 1)
/** @addtogroup SRAM_Exported_Functions_Group5 Callback functions
  * @{
  */
